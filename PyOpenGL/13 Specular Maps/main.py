...
#specify texture level 0 as the diffuse map
glUniform1i(glGetUniformLocation(shader,"material.diffuse"),0)
#specify texture level 1 as the specular map
...
def importTextures():
    ...
    tex = Texture("tex/floor0.jpg")
    TEXTURES["floor"].append(tex)
    tex = Texture("tex/floor0_specular.jpg")
    SPECULAR_TEXTURES["floor"].append(tex)

    tex = Texture("tex/floor1.jpg")
    TEXTURES["floor"].append(tex)
    tex = Texture("tex/floor1_specular.jpg")
    SPECULAR_TEXTURES["floor"].append(tex)

    tex = Texture("tex/wall.jpg")
    TEXTURES["wall"].append(tex)
    tex = Texture("tex/wall_specular.jpg")
    SPECULAR_TEXTURES["wall"].append(tex)

    tex = Texture("tex/wall1.jpg")
    TEXTURES["wall"].append(tex)
    tex = Texture("tex/wall1_specular.jpg")
    SPECULAR_TEXTURES["wall"].append(tex)

    tex = Texture("tex/ceiling0.jpg")
    TEXTURES["ceiling"].append(tex)
    tex = Texture("tex/ceiling0_specular.jpg")
    SPECULAR_TEXTURES["ceiling"].append(tex)

    tex = Texture("tex/ceiling1.jpg")
    TEXTURES["ceiling"].append(tex)
    tex = Texture("tex/ceiling1_specular.jpg")
    SPECULAR_TEXTURES["ceiling"].append(tex)
...
class Wall(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        glBindTexture(GL_TEXTURE_2D,SPECULAR_TEXTURES["wall"][self.texture].id)
...
class Floor(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        glActiveTexture(GL_TEXTURE1)
        glBindTexture(GL_TEXTURE_2D,SPECULAR_TEXTURES["floor"][self.texture].id)
        glDrawArrays(GL_TRIANGLE_FAN,0,4)
...
class Ceiling(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        glActiveTexture(GL_TEXTURE1)
        glBindTexture(GL_TEXTURE_2D,SPECULAR_TEXTURES["ceiling"][self.texture].id)
        glDrawArrays(GL_TRIANGLE_FAN,0,4)
...
SPECULAR_TEXTURES = {"floor":[],"wall":[],"ceiling":[]}
importTextures()
